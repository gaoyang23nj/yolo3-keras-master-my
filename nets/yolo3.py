...
def yolo_head(feats, anchors, num_classes, input_shape, calc_loss=False):
    ...
    #                 [batchsize, 1, grid_shape[1], 1, 1])
    # grid_x = K.tile(K.reshape(K.arange(0, stop=grid_shape[1]), [1, -1, 1, 1]),
    #                 [batchsize, grid_shape[0], 1, 1, 1])
    ...
    batchsize = K.shape(feats)[0]
    # tmp_anchos_tensor = K.tile(anchors_tensor, [batchsize, grid_shape[0], grid_shape[1], 1, 1])
